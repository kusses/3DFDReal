...
=======
# Real-World 3D Fashion Dataset for Virtual Try-On Applications
...
---
## Acknowledgements
This code is based on the repository of RRT: Instance-level Image Retrieval using Reranking Transformers.
CVNet extraction code is based on the repository of CVNet: Correlation Verification for Image Retrieval.
Point cloud processing is based on [Pointcept](https://github.com/Pointcept/Pointcept): A Codebase for Point Cloud Perception Research.
Octree-based attention mechanism is inspired by [OctFormer](https://github.com/octree-nn/octformer): Octree-based Transformers for 3D Point Clouds.


>>>>>>> a9406d39b39518ad2d1d434af778a90f4989b7e5
